...
export default function Dashboard() {
  ...
  const addActivity = (type, text) => {
    setActivity((prev) => [
      { id: Date.now(), type, text, timestamp: Date.now() },
      ...prev,
    ]);
  };
  ...
  const handleApply = (job) => {
    addActivity(
      "pending",
      `Started proposal for ${job.clientName || "Client"}`,
    );
    navigate("/freelancer/proposals", {
      state: { applyJob: serializeJob(job) },
    });
  };
        ...
        <div className="content-grid">
          <section className="jobs-col">
            ...
            <div className="job-list">
              {jobs.length === 0 ? (
                <p
                  style={{ color: "#888", fontSize: "14px", padding: "16px 0" }}
                >
          ...
          <aside className="right-col">
            ...
            <div className="panel-card">
              ...
              <p className="strength-hint">
                Add a portfolio to reach <strong>90%</strong> and get 3× more
                visibility.
              </p>
              <button
            ...
            <div className="panel-card panel-card--ai">
              ...
              <p className="ai-text">
                Jobs requiring <strong>TypeScript</strong> have 40% less
