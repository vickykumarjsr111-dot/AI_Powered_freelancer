    ...
    try {
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          id: Date.now(),
          type: "pending",
          text: `Proposal sent to ${selectedJob.company}`,
          timestamp: Date.now(),
        }),
      );
      const oldActivity =
      ...
      const newActivity = {
        id: Date.now(),
        type: "pending",
        text: `Proposal submitted to ${selectedJob.company}`,
        timestamp: Date.now(),
      };

      localStorage.setItem(
        "activityData",
        JSON.stringify([newActivity, ...oldActivity]),
      );
      setShowModal(false);
    } catch (err) {
      console.error(err);
          ...
          <div className="fp-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="fp-modal-actions">
              ...
              <button
                ...
                disabled={
                  submitting || !form.coverLetter.trim() || !form.bidAmount
                }
              >
